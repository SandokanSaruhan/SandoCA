<?php 
	...
	if(empty($f_name) || empty($l_name) || empty($email) || empty($password) || empty($mobile) || empty($address1) || empty($address2)){
		...
		exit();
					...
					$sql="INSERT INTO user_info (first_name, last_name, email, password, mobile, address1, address2, role) VALUES ('$f_name','$l_name','$email','$password','$mobile','$address1','$address2','user')";
