		...
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<ul class="dropdown-menu">
					...
					<li><a href="test_admin.php">Admin</a></li><!--"//Sando Admin Control" must be added-->
				</ul>
				...
				<div class="panel panel-info">
					<div class="panel-heading text-center">--Featured Products--
							<div class='pull-right'>
								Sort: &nbsp;&nbsp;&nbsp;<a href="#" id='price_sort'>Price</a> | <a href="#" id='pop_sort'>Popularity</a> | <a href="#" id='rand_sort'>Random</a> | <a href="#" id='range_sort'>Range</a><input type="range" id="price-range" name="price-range" min="0" max="100000" step="10" value="50"><span id="range-display">50</span> 
							</div>
					</div>
	...
	<script>
		...
		document.addEventListener("DOMContentLoaded", function() {
  			...
  			rangeSlider.addEventListener("input", function() {
    			...
    			rangeDisplay.textContent = currentValue; // Update the displayed value
  			});
		});
</script>
</body>
