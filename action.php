<?php 
	...
	if(isset($_POST['getProduct'])){
		...
		elseif(isset($_POST['pop_sorted'])){
			...
			$product_query="SELECT * FROM products ORDER BY product_popularity DESC"; //Sort Func
		}
		elseif(isset($_POST['rand_sorted'])){ //Sort Func
			$product_query="SELECT * FROM products ORDER BY rand()";
		}
		elseif(isset($_POST['range_sorted'])){ //Sort Func
			$maxPrice=$_POST['maxData'];
			//$product_query = "SELECT * FROM products WHERE product_price <= 500;";
			$product_query = "SELECT * FROM products WHERE product_price <= $maxPrice;";
		}
		else{
		...
		if(mysqli_num_rows($run_query)){
			while($row=mysqli_fetch_array($run_query)){
				...
				$pop=$row['product_popularity']; //Sort Func
				...
				echo "<div class='col-md-4'>
							<div class='panel panel-info'>
								...
								<div class='panel-heading'>Rs $price - Pop $pop 
	...
	//Admin Sales
	//if(isset($_POST['cartmenu']) || isset($_POST['carts_checkout_admin']))
	if(isset($_POST['carts_checkout_admin']))
	{
		$uid=$_SESSION['uid'];
		$sql="SELECT * FROM cart";
		$run_query=mysqli_query($conn,$sql);
